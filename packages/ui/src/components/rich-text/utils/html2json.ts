...
let inline = makeMap(
  "abbr,acronym,applet,b,basefont,bdo,big,button,cite,del,dfn,em,font,i,iframe,img,input,ins,kbd,label,map,object,q,s,samp,script,select,small,span,strike,strong,sub,sup,textarea,tt,u,let"
);
  ...
  HTMLParser(html, {
    start: function (tag, attrs, unary) {
      ...
      if (unary) {
        ...
        // add to parents
        let parent: any = bufArray[0] || results;
        if (parent.nodes === undefined) {
          parent.nodes = [];
        }
